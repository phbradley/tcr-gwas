...
bootstrap_weighted_productive = regression_weighted_bootstrap_se(subset_snps_no_NA, trimming, productive = "True", repetitions = 500, gene_type = 'v_gene')
print("finished bootstrap_weighted_productive")

bootstrap_weighted_NOT_productive = regression_weighted_bootstrap_se(subset_snps_no_NA, trimming, productive = "False", repetitions = 500, gene_type = 'v_gene')
