...
TOTAL_COUNT=$(ls /fh/fast/matsen_e/shared/tcr-gwas/trimming_regression_output/cluster_job_results/$1/100_bootstraps | wc -l)
while (( $TOTAL_COUNT < 35482 ))
do
    ...
    do
        for CONFIG in $(find /home/mrussel2/tcr-gwas/trimming_regression/send_regressions_to_cluster/random_effects_cluster_job_directory_100_boots_subset/$1/ -name "run_script_on_cluster.sh" -exec ls {} + ); do
            cd $(dirname $CONFIG)
