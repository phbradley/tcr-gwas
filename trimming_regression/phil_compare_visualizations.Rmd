...
phil_snp_list = combine_trimming_regression_dfs(pre_regression_snp_list, repetitions = 100, condensing = 'by_gene', trimming_type_list = c('v_trim', 'd0_trim', 'd1_trim', 'j_trim', "vd_insert", "vj_insert", "dj_insert"))
...
gene_conditioning_crosses = as.data.table(read.table("regression_bootstrap_results/crosses/crossing_all_snplist_16814629-16814111_snps_lmer_with_gene_with_weighting_condensing_by_gene_0_bootstraps.tsv", header = TRUE))
```
...
```{r echo=TRUE, warning=FALSE}
visualize_crosses(gene_conditioning_crosses)
```
