...
registerDoParallel(cores=3)
    foreach(trim_type=c('d0_trim', 'v_trim', 'j_trim')) %dopar% {
        RcppParallel::setThreadOptions(1L) 
        compile_all_data_from_cluster(trim_type = trim_type, random_effects = 'True', bootstrap_count = 100, pca_structure_correction = 'True') }
stopImplicitCluster()
