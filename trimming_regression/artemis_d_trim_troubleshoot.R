...
by_patient_no_weight_d0 = run_snps_trimming_snp_list(snp_id_list = snps_list, trim_type = 'd0_trim', gene_type = 'd_gene', condensing = 'by_patient', gene_conditioning = 'False', weighting = 'False', repetitions = 0, write_table = 'False')