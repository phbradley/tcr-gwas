...
#```{r j_trimming_plot_boot_no_pca, echo=TRUE, warning=FALSE}
...
#```{r v_trimming_plot_boot_no_pca, echo=TRUE, warning=FALSE}
...
#```{r d0_trimming_plot_boot_no_pca, echo=TRUE, warning=FALSE}
...
#```{r d1_trimming_plot_boot_no_pca, echo=TRUE, warning=FALSE}
...
#```{r vd_insert_plot_boot_no_pca, echo=TRUE, warning=FALSE}
...
#```{r dj_insert_plot_boot_no_pca, echo=TRUE, warning=FALSE}
...
#```{r vj_insert_plot_boot_no_pca, echo=TRUE, warning=FALSE}
...
```{r ALL_trimming_plot_boot_no_pca, echo=TRUE, warning=FALSE}
...
```{r ALL_insertion_plot_boot_no_pca, echo=TRUE, warning=FALSE}
...
```{r ALL_trimming_plot_boot_no_pca_ARTEMIS, echo=TRUE, warning=FALSE}
