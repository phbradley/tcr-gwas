...
ggsave(paste0(PROJECT_PATH, '/tcr-gwas/figures/vj_insert_boxplot_', CHAIN, '_rs3762093.pdf'), plot = final_vj_insert_boxplot, width = 14, height = 10, units = 'in', dpi = 750, device = cairo_pdf)
