...
features = c('d1_trim_j1_subset', 'd0_trim_j1_subset')
...
manhattan_plot(dataframe = compile_manhattan_plot_data(features), 
               ...
               plot_title = '', 
               file_name = make_file_name('trimming_j1_subset'), 
               plotting_p_value_cutoff = plotting_cutoff)
assign('trimming_manhattan', readRDS(paste0(make_file_name('trimming_j1_subset'), '.rds')))
...
file_name = paste0(make_file_name('trimming_j1_subset'), '.pdf')
