...
```{r p_addition_count echo=TRUE, warning=FALSE}
...
```{r p_addition_fraction echo=TRUE, warning=FALSE}
...
```{r trimming echo=TRUE, warning=FALSE}
...
```{r trimming_naive echo=TRUE, warning=FALSE}
...
```{r insertion echo=TRUE, warning=FALSE}
...
```{r total_insert echo=TRUE, warning=FALSE}
...
```{r insertion_no_pca echo=TRUE, warning=FALSE}
...
```{r p_addition_fraction_zero_trimming_subset echo=TRUE, warning=FALSE}
...
```{r zero_trimming_fraction echo=TRUE, warning=FALSE}
