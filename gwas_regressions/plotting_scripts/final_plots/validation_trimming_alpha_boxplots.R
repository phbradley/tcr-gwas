...
ggsave(paste0(PROJECT_PATH, '/tcr-gwas/gwas_regressions/figures/multipanel_trimming_boxplot_', CHAIN, '_rs12768894.pdf'), plot = together, width = 12, height = 17, units = 'in', dpi = 750, device = cairo_pdf)
