...
ggsave(paste0(PROJECT_PATH, '/tcr-gwas/gwas_regressions/figures/multipanel_insertion_boxplot_', CHAIN, '_rs3762093.pdf'), plot = together, width = 12, height = 17, units = 'in', dpi = 750, device = cairo_pdf)
