...
ggsave(paste0(PROJECT_PATH, '/tcr-gwas/gwas_regressions/figures/pc_multipanel_plot.pdf'), plot = together_leg, width = 35, height = 13, units = 'in', dpi = 750, device = cairo_pdf)
